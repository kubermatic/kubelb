...
![Version: v99.0.0](https://img.shields.io/badge/Version-v99.0.0-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v99.0.0](https://img.shields.io/badge/AppVersion-v99.0.0-informational?style=flat-square)
...
```bash
cosign verify quay.io/kubermatic/helm-charts/kubelb-manager:v99.0.0 \
...
```bash
cosign verify quay.io/kubermatic/kubelb-manager:v99.0.0 \
  --certificate-identity-regexp="^https://github.com/kubermatic/kubelb/.github/workflows/release.yml@refs/tags/v.*" \
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com
```
