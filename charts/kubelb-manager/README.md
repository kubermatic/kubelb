...
![Version: v99.0.1](https://img.shields.io/badge/Version-v99.0.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v99.0.1](https://img.shields.io/badge/AppVersion-v99.0.1-informational?style=flat-square)
...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-manager --version=v99.0.1 --untardir "." --untar
## Apply CRDs
...
```bash
cosign verify quay.io/kubermatic/helm-charts/kubelb-manager:v99.0.1 \
...
```bash
cosign verify quay.io/kubermatic/kubelb-manager:v99.0.1 \
  --certificate-identity-regexp="^https://github.com/kubermatic/kubelb/.github/workflows/release.yml@refs/tags/v.*" \
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com
```
