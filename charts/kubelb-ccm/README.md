...
```sh
helm pull oci://quay.io/kubermatic/helm-charts/kubelb-ccm --version=v99.0.1 --untardir "." --untar
## Apply CRDs
...
```bash
cosign verify quay.io/kubermatic/helm-charts/kubelb-ccm:v99.0.1 \
...
```bash
cosign verify quay.io/kubermatic/kubelb-ccm:v99.0.1 \
  --certificate-identity-regexp="^https://github.com/kubermatic/kubelb/.github/workflows/release.yml@refs/tags/v.*" \
  --certificate-oidc-issuer=https://token.actions.githubusercontent.com
```
