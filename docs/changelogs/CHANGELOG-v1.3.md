...
- Upgrade to Go 1.26.2 ([#389](https://github.com/kubermatic/kubelb/pull/389))
...
- Kgateway has now been replaced with agentgateway. Kgateway upstream moved all the AI-extension functionality out of kgateway into agentgateway. ([#395](https://github.com/kubermatic/kubelb/pull/395))
