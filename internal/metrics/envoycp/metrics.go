...
var (
	...
	SnapshotGenerationDuration = metrics.NewHistogramVec(
		metrics.SubsystemEnvoyCP,
...
var (
	...
	ClustersTotal = metrics.NewGaugeVec(
		metrics.SubsystemEnvoyCP,
		"clusters",
	...
	ListenersTotal = metrics.NewGaugeVec(
		metrics.SubsystemEnvoyCP,
		"listeners",
	...
	EndpointsTotal = metrics.NewGaugeVec(
		metrics.SubsystemEnvoyCP,
		"endpoints",
...
var (
	...
	GRPCConnectionsTotal = metrics.NewGauge(
		metrics.SubsystemEnvoyCP,
		"grpc_connections",
	...
	GRPCResponsesTotal = metrics.NewCounterVec(
		metrics.SubsystemEnvoyCP,
...
var (
	...
	CacheClearsTotal = metrics.NewCounterVec(
		metrics.SubsystemEnvoyCP,
		"cache_clears_total",
...
var (
	...
	EnvoyProxyCreateTotal = metrics.NewCounterVec(
		metrics.SubsystemEnvoyCP,
	...
	EnvoyProxyDeleteTotal = metrics.NewCounterVec(
		metrics.SubsystemEnvoyCP,
