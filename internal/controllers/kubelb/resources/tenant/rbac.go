			...
			r.Rules = []rbacv1.PolicyRule{
				{
					...
					Resources: []string{"loadbalancers", "routes", "addresses", "syncsecrets", "tunnels"},
					Verbs: []string{
						"create",
						"update",
						"get",
				...
				{
					APIGroups: []string{"kubelb.k8c.io"},
					Resources: []string{"loadbalancers/status", "routes/status", "addresses/status", "syncsecrets/status", "tunnels/status"},
					Verbs: []string{
						"update",
						"get",
						"patch",
