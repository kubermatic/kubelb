...
// FakeTCPLoadBalancers implements TCPLoadBalancerInterface
type FakeTCPLoadBalancers struct {
	Fake *FakeKubelbV1alpha1
	ns   string
}

var tcploadbalancersResource = schema.GroupVersionResource{Group: "kubelb.k8c.io", Version: "v1alpha1", Resource: "tcploadbalancers"}
